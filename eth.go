...
type ChainInterface interface{
    ...
    State() modules.State //map[string]string // the full chain state ... this won't scale
...
type EthChain interface{
    ...
    GetState() modules.State //map[string]string
    GenDoug() string
    StartMining() bool
    StopMining() bool
}
...
func (e *EthD) State() modules.State{ //map[string]string {
